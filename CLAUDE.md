# CLAUDE.md — Instructions for Claude Code (HomeServicesAdminWeb)

## What this repo is
**HomeServicesAdminWeb** — Admin ops web dashboard. Agent pipeline wired from `ai-agent-cursor-claude`.

Stack: Vite + React + TypeScript + React Router + Zustand + i18next
